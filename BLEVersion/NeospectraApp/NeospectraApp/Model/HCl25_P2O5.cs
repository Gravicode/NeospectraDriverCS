...
namespace NeospectraApp
{
    ...
    public sealed class HCl25_P2O5Model
    {
        ...
        public static async Task<HCl25_P2O5Model> LoadModelAsync(string modelFileName)
        {
        ...
        public async Task<float> ProcessOutputAsync(HCl25_P2O5Output evalOutput)
        {
            // Get the label and loss from the output
            var label = evalOutput.StatefulPartitionedCall00.GetAsVectorView()[0];
            // Format the output string
            string score = $"{nameof(HCl25_P2O5Output)} => {label}";

...
namespace NeospectraApp
{
    ...
    public sealed class SANDModel
    {
        ...
        public static async Task<SANDModel> LoadModelAsync(string modelFileName)
        {

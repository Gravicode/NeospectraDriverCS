...
namespace NeospectraApp.Driver
{
    ...
    {
        public static string KEY_MODULE_ID = "MODULE_ID";
        public static string KEY_ERROR_NOT_FOUND = "Not Found";
        public static string FILE_NAME_RESULTS_old = "neoSpectraResultFile";
        public static string FILE_NAME_RESULTS = "neoSpectra_resultFile";
        ...
        public static int TYPE_FILTER_TIME = 2;

        public static int MAX_SCANNER_MEMORY = 150;

        /*For filter Headers*/
        public static string[] FILTER_HEADERS = { "Modules", "Time" };
        public static string[] FILTER_TIME_MODULE_ITEMS = { "All", "This Week" };

        public static String filterDate;
        public static List<String> filterModulesName = new List<string>();

        public static object measurmentsViewCaller;
        ...
        public static string SPECTRUMFILE_Y_AXIS_R_T = "y_Axis:%Reflectance";
        public static string SPECTRUMFILE_Y_AXIS_A = "y_Axis:Absorbance";

        public static string SPECTRUM_FILE_X_AXIS_CM = "x_Axis:Wavenumber (cm-1)";
        public static string SPECTRUM_FILE_X_AXIS_NM = "x_Axis:Wavelength (nm)";

        public static string SPECTRUM_DEFAULT_PATH_TEMPLATE = "Measurement";
        public static string SPECTRUM_REFL_PATH_TEMPLATE = "_Perc_";
        public static string SPECTRUM = ".Spectrum";
        public static string SPECTRUM_ABS_PATH_TEMPLATE = "_Abs_";

        public static string OutputDirectory = KnownFolders.DocumentsLibrary
                + "/" + "NeoSpectra";

        public class OTA_Functions
        {
            public static readonly string UPDATE_FIRMWARE = "Update Firmware";

            public static readonly string RESET_FIRMWARE = "Reset Firmware";

            private int value;
            public OTA_Functions(int value)
            {
                this.value = value;
            }
            public int getValue()
        ...
        {
            public static readonly string P3_SERVICE = "P3 Service";
            public static readonly string SYSTEM_STATUS_SERVICE = "System Status Service";
            public static readonly string MEMORY_SERVICE = "Memory Service";
            public static readonly string BATTERY_SERVICE = "Battery Service";

        }

        public class command
        {
            public static readonly string Read_RunModule_ID = "01: Read Module ID";
            public static readonly string Run_PSD = "03: Run PSD";
            public static readonly string Run_Background = "04: Run Background";
            public static readonly string Run_Absorbance = "05: Run Absorbance";
            public static readonly string Run_GainAdjustment = "06: Run Gain Adjustment";
            public static readonly string Burn_Gain = "07: Burn Gain";
            public static readonly string Burn_Self = "08: Burn Self";
            public static readonly string Burn_WLN = "09: Burn WLN";
            public static readonly string Run_SelfCorrection = "10: Run Self Correction";
            public static readonly string Run_WavelengthCorrectionBackground = "11: Run Wavelength Correction Background";
            public static readonly string Run_WavelengthCorrection = "12: Run Wavelength Correction";
            public static readonly string Restore_Defaults = "13: Restore Defaults";
            public static readonly string Set_Optical_Settings = "27: Set Optical Settings";
            public static readonly string Get_Calibration_Wells = "90: Get Calibration Wells";
            public static readonly string Get_Calibration_Wells1 = "91: Get Calibration Wells";
        }

        public class pointsCount
        {
            public static readonly string disable = "0: disable";

            public static readonly string points_65 = "1: 65 points";

            public static readonly string points_129 = "2: 129 points";
            public static readonly string points_257 = "3: 257 points";
            public static readonly string points_513 = "4: 513 points";
            public static readonly string points_1024 = "5: 1024 points";
            public static readonly string points_2048 = "6: 2048 points";
            public static readonly string points_4096 = "7: 4096 points";

        }

        public class opticalGain
        {
            public static readonly string UseSettingsSavedonDVK = "0: Use Settings Saved on DVK";
            public static readonly string UseCalculatedSettings = "1: Use Calculated Settings";
            public static readonly string UseExternalSettings = "2: Use External Settings";
        }

        public class apodization
        {
            public static readonly string Boxcar = "0: Boxcar";
            public static readonly string Gaussian = "1: Gaussian";
            public static readonly string HappGenzel = "2: Happ-Genzel";
            public static readonly string Lorenz = "3: Lorenz";
        }

        public class zeroPadding
        {
            public static readonly string points_8k = "1: 8k points";
            public static readonly string points_16k = "2: 16k points";
            public static readonly string points_32k = "3: 32k points";
        }

        public class runMode
        {
            public static readonly string Single_Mode = "0: Single Mode";
            public static readonly string Continuous_Mode = "1: Continuous Mode";
        }
        public class wavelengthCorrection
        {
            public static readonly string Self_Calibration = "SelfCorrection";
            public static readonly string Correction_Using_Reference_Calibrator = "ReferenceMaterialCorrection";

        }

        public static String gRunMode = runMode.Single_Mode;
        public static bool gIsInterpolationEnabled = false;
        public static String gInterpolationPoints = pointsCount.points_129;
        public static bool gIsFftEnabled = false;
        public static String gApodizationFunction = apodization.Boxcar;
        public static String gFftPoints = zeroPadding.points_8k;
        public static String gOpticalGainSettings;
        public static int gOpticalGainValue;
        public static List<dbReading> gAllSpectra = new List<dbReading>();
        public static String gDeviceName = "";
        public static bool mLastPressed = true;
        public static String gCorrectionMode = wavelengthCorrection.Self_Calibration;
        ...
        public class mainTasksHelper
        {
            public static mainTasks getTask(int id)
            {
                mainTasks returnTask;
                switch (id)
                {
                    case 1:
                        returnTask = mainTasks.preProcessing;
                        break;
                    case 2:
                        returnTask = mainTasks.featureExtraction;
                        break;
                    case 3:
                        returnTask = mainTasks.scaling;
                        break;
                    default:
                        returnTask = mainTasks.none;
                        break;
            ...
            public static int getID(mainTasks type)
            {
                int id;
                switch (type)
                {
                    case mainTasks.preProcessing:
                        id = 1;
                        break;
                    case mainTasks.featureExtraction:
                        id = 2;
                        break;
                    case mainTasks.scaling:
                        id = 3;
                        break;
                    default:
                        id = -1;
        ...
        {
            public static regression getMethod(int id)
            {
                regression returnReg;
                switch (id)
                {
                    case 10:
                        returnReg = regression.PCR;
                        break;
                    case 20:
                        returnReg = regression.PLS;
                        break;
                    case 30:
                        returnReg = regression.SVR;
                        break;
                    case 40:
                        returnReg = regression.GPR;
                        break;
                    default:
                        returnReg = regression.none;
                        break;
                }
                return returnReg;
            }

            public static int getID(regression type)
            {
                int id;
                switch (type)
                {
        ...
        {
            public static preProcessing getMethod(int id)
            {
                preProcessing tmpName;
                switch (id)
                {
                    case 101:
                        tmpName = preProcessing.osc1;
                        break;
                    case 102:
                        tmpName = preProcessing.osc2;
                        break;
                    case 103:
                        tmpName = preProcessing.emsc;
                        break;
                    case 104:
                        tmpName = preProcessing.sfs;
                        break;
                    case 105:
                        tmpName = preProcessing.oplec;
                        break;
                    case 106:
                        tmpName = preProcessing.snv;
                        break;
                    default:
                        //logMessage("err", "You didn't chose a valid preProcessing method id");
                        tmpName = preProcessing.none;
                        break;
                }
                return tmpName;
            }

            public static int getID(preProcessing type)
            {
                int id;
                switch (type)
                {
                    case preProcessing.osc1:
                        id = 101;
                        break;
                    case preProcessing.osc2:
                        id = 102;
                        break;
                    case preProcessing.emsc:
                        id = 103;
                        break;
                    case preProcessing.sfs:
                        id = 104;
                        break;
                    case preProcessing.oplec:
                        id = 105;
                        break;
                    case preProcessing.snv:
                        id = 106;
                        break;
                    default:
                        id = -1;
        ...
        {
            public static featureExtraction getMethod(int id)
            {
                featureExtraction tmpName;
                switch (id)
                {
                    case 201:
                        tmpName = featureExtraction.differentiate;
                        break;
                    case 202:
                        tmpName = featureExtraction.differentiateMultipleLevels;
                        break;
                    case 203:
                        tmpName = featureExtraction.integrate;
                        break;
                    case 204:
                        tmpName = featureExtraction.integralPlusOriginal;
                        break;
                    case 205:
                        tmpName = featureExtraction.covariance;
                        break;
                    case 206:
                        tmpName = featureExtraction.catIntegralDifferentiation;
                        break;
                    case 207:
                        tmpName = featureExtraction.differentiateCat;
                        break;
                    case 208:
                        tmpName = featureExtraction.multiLevelCovariance;
                        break;
                    case 209:
                        tmpName = featureExtraction.detrending1;
                        break;
                    case 210:
                        tmpName = featureExtraction.detrending2;
                        break;

                    default:
                        //logMessage("err", "You didn't chose a valid featureExtraction method id: " + id);
                        tmpName = featureExtraction.none;
                        break;
                }
                return tmpName;
            }

            public static int getID(featureExtraction type)
            {
                int id;
                switch (type)
                {
                    case featureExtraction.differentiate:
                        id = 201;
                        break;
                    case featureExtraction.differentiateMultipleLevels:
                        id = 202;
                        break;
                    case featureExtraction.integrate:
                        id = 203;
                        break;
                    case featureExtraction.integralPlusOriginal:
                        id = 204;
                        break;
                    case featureExtraction.covariance:
                        id = 205;
                        break;
                    case featureExtraction.catIntegralDifferentiation:
                        id = 206;
                        break;
                    case featureExtraction.differentiateCat:
                        id = 207;
                        break;
                    case featureExtraction.multiLevelCovariance:
                        id = 208;
                        break;
                    case featureExtraction.detrending1:
                        id = 209;
                        break;
                    case featureExtraction.detrending2:
                        id = 210;
                        break;
                    default:
                        id = -1;
        ...
        public static SWS_P3API bluetoothAPI { set; get; }

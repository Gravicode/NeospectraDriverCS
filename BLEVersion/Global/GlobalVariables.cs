...
using com.gravicode.neospectralib.BluetoothSDK.SWS_P3API;
using com.gravicode.neospectralib.BluetoothSDK.SWS_P3BLEDevice;
using com.gravicode.neospectralib.Models.dbReading;
using java.io.File;
...
public class GlobalVariables {
    ...
    public static String[] FILTER_HEADERS;
    
    public static String[] Time;
    
    public static String[] FILTER_TIME_MODULE_ITEMS;
    
    public static String[] This Week;
    ...
    public static String OutputDirectory = (Environment.DIRECTORY_DCIM 
...
,RESET_FIRMWARE(1);
{UnknownprivateOTA_Functions(int, value);
{this.value = value;
UnknownUnknownpublic enum Service {
...
Unknown,SYSTEM_STATUS_SERVICE;
{Unknown,MEMORY_SERVICE;
{Unknown,BATTERY_SERVICE;
{UnknownUnknownpublic enum command {
...
Unknown,Run_PSD;
{Unknown,Run_Background;
{Unknown,Run_Absorbance;
{Unknown,Run_GainAdjustment;
{Unknown,Burn_Gain;
{Unknown,Burn_Self;
{Unknown,Burn_WLN;
{Unknown,Run_SelfCorrection;
{Unknown,Run_WavelengthCorrectionBackground;
{Unknown,Run_WavelengthCorrection;
{Unknown,Restore_Defaults;
{Unknown,Set_Optical_Settings;
{Unknown,Get_Calibration_Wells;
{Unknown,Get_Calibration_Wells1;
{UnknownUnknownpublic enum pointsCount {
...
{Unknown,points_2048;
{Unknown,points_4096;
{UnknownUnknownpublic enum opticalGain {
    ...
    0: Use Settings Saved on DVK,
    
    ;,
}
Unknown,UseCalculatedSettings;
{Unknown,UseExternalSettings;
{UnknownUnknownpublic enum apodization {
...
{Unknown,HappGenzel;
{Unknown,Lorenz;
{UnknownUnknownpublic enum zeroPadding {
...
Unknown,points_16k;
{Unknown,points_32k;
{UnknownUnknownpublic enum runMode {
...
Unknown,Continuous_Mode;
{UnknownUnknownpublic enum wavelengthCorrection {
...
Unknown,Correction_Using_Reference_Calibrator;
{UnknownUnknownpublic enum mainTasks {
    ...
    You didn't chose a valid mainTasks method id,
...
return id;
UnknownUnknownpublic enum regression {
    ...
    You didn't chose a valid regression method id,
...
return id;
UnknownUnknownpublic enum preProcessing {
    ...
    You didn't chose a valid preProcessing method id,
...
return id;
UnknownUnknownpublic enum featureExtraction {
    ...
    You didn't chose a valid featureExtraction method id: ,
...
return tmpName;
UnknownNonNull featureExtraction;
type;
Unknown{switch (type) {
    case differentiate:
        id = 201;
...
return id;
UnknownUnknownatNonNull;
publicstaticdouble[] WVL = new double[] {
        2601.454642,
        2593.140844,
        2584.880015,
        2576.671651,
...
UnknownUnknown
    ...
    [Nullable()]
    [NonNull()]
    public static double[] sampleReadings = new double[] {
            1,
            0.00224038,
            0.0025984,
            0.00293276,
    ...
    // ,0.00662772,0.00668032,0.00673049,0.00676474};
    [NonNull()]
    public static double[] sample0 = sampleReadings;
    
    [NonNull()]
    public static double[] sample1 = new double[] {
            0.00196538,
            0.00227534,
            0.00255638,
            0.00278483,
    ...
    [NonNull()]
    public static double[] sample2 = new double[] {
            0.00196165,
            0.00233573,
            0.00267985,
            0.00296303,
    ...
    [NonNull()]
    public static double[] sample3 = new double[] {
            0.00181514,
            0.00213637,
            0.00242268,
            0.00266229,
    ...
    [NonNull()]
    public static double[] sample4 = new double[] {
            0.00180623,
            0.00213185,
            0.00244339,
            0.00271796,
    ...
    [NonNull()]
    public static double[] sample5 = new double[] {
            0.00180931,
            0.00215129,
            0.00246273,
            0.00271943,
    ...
    [NonNull()]
    public static double[] sample6 = new double[] {
            0.00231162,
            0.00266521,
            0.00300132,
            0.00329522,
    ...
    [NonNull()]
    public static double[] sample7 = new double[] {
            0.00224038,
            0.0025984,
            0.00293276,
            0.0032202,
    ...
    [NonNull()]
    public static double[] sample8 = new double[] {
            0.00227543,
            0.00263154,
            0.00295851,
            0.0032391,
    ...
    [NonNull()]
    public static double[] sample10 = new double[] {
            0.00242287,
            0.00276573,
            0.00310575,
            0.00341126,
    ...
    [NonNull()]
    public static double[] sample9 = new double[] {
            0.00237581,
            0.00278292,
            0.00312396,
            0.0033733,
    ...
    [NonNull()]
    public static double[] xReading2;
    
    [NonNull()]
    public static double[] xReading3;
